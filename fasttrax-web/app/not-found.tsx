...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#000418] flex flex-col items-center justify-center text-center px-4">
      <h1
        className="font-[var(--font-anton)] italic uppercase text-white mb-4"
        style={{ fontSize: "clamp(80px, 20vw, 200px)", lineHeight: "1", textShadow: "rgba(229,0,0,0.48) 0px 0px 30px" }}
      >
        404
      </h1>
      <h2
        className="font-[var(--font-anton)] italic uppercase text-white mb-6"
        style={{ fontSize: "clamp(24px, 5vw, 48px)", lineHeight: "1", letterSpacing: "3px" }}
      >
        Wrong Turn, Racer
      </h2>
      <p className="font-[var(--font-poppins)] text-white/70 text-lg mb-10 max-w-md">
        Looks like you took a detour off the track. Let&apos;s get you back to the action.
      </p>
      <div className="flex flex-wrap gap-4 justify-center">
        <Link
          href="/"
          className="font-[var(--font-poppins)] font-bold uppercase text-white tracking-wider transition-all hover:scale-105"
