...
const racingFaqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! Nemo's Brickyard Bistro is FastTrax's full-service trackside restaurant featuring authentic wood-fired brick oven pizza, craft cocktails, beer, and a full menu. Watch live racing from your table. Live entertainment every Friday and Saturday night.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "FastTrax is Fort Myers' top rainy day activity — 63,000 sq ft of fully indoor, climate-controlled entertainment including go-kart racing on multi-level tracks, 50+ arcade games, duckpin bowling, shuffleboard, and Nemo's Brickyard Bistro. No weather worries. Open Mon-Thu 3-11 PM, Fri 3 PM-12 AM, Sat 11 AM-12 AM, Sun 11 AM-11 PM.",
  },
  {
    question: "Does FastTrax have birthday party packages?",
    answer:
      "Yes! FastTrax hosts birthday parties for all ages with private racing heats, dedicated event coordinators, VIP viewing areas, and catering by Nemo's Brickyard Bistro. Groups of 14 to 1,000+ guests. Visit our Group Events page or call to start planning your party.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "FastTrax is one of the best date night spots in Fort Myers. Race go-karts together, grab craft cocktails and brick oven pizza at Nemo's Brickyard Bistro with trackside views, play arcade games, or try duckpin bowling. Live entertainment every Friday and Saturday night. Way more exciting than dinner and a movie.",
  },
  {
    question: "Does FastTrax do corporate team building events?",
    answer:
      "Yes — FastTrax is Fort Myers' premier corporate event venue. We offer private racing heats, team competitions with live timing, VIP lounge access, dedicated meeting rooms, catering packages by Nemo's Brickyard Bistro, and dedicated event coordinators for groups of 14 to 1,000+. More engaging than Topgolf corporate events and more variety than Dave & Buster's.",
  },
  {
