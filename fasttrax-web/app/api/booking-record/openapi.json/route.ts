...
const spec = {
  ...
  info: {
    ...
    description:
      "Read booking records for check-in integration. All endpoints require `x-api-key` header.",
    version: "1.0.0",
  },
  servers: [
      ...
      BookingRecord: {
        ...
        properties: {
          ...
          status: {
            ...
            description: "pending_payment before checkout, confirmed after",
          },
          reservationNumber: {
            type: "string",
            description: "BMI reservation number (e.g. W23905). Set after payment confirmation.",
            nullable: true,
          },
          reservationCode: {
            type: "string",
            description: "QR code value for check-in scanning",
            nullable: true,
          },
          confirmations: {
            type: "array",
  ...
  paths: {
    "/api/booking-record": {
      get: {
        ...
        description:
          "Query by billId, reservation number, personId, or date. Returns a single record or array depending on query type.",
        parameters: [
          {
            name: "billId",
            in: "query" as const,
          ...
          },
          {
            ...
            in: "query" as const,
            schema: { type: "string" },
            description: "Reservation number (e.g. W23905)",
          },
          {
            name: "personId",
            in: "query" as const,
            schema: { type: "string" },
            description: "BMI person ID — returns array of all bookings for this person",
          },
          {
            name: "date",
            in: "query" as const,
            schema: { type: "string", format: "date" },
            description: "Race date YYYY-MM-DD — returns array of all bookings on this date",
          },
        ],
        responses: {
          "200": {
              ...
              "application/json": {
                schema: {
                  oneOf: [
                    ...
                    { type: "array", items: { $ref: "#/components/schemas/BookingRecord" } },
                  ],
                },
              },
            },
