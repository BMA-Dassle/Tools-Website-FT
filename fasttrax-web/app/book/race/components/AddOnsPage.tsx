...
const ADD_ONS: (Omit<AddOnItem, "quantity"> & { discountLabel?: string; saveLabel?: string })[] = [
  ...
  {
    id: "23345625",
    name: "FastTrax Shuffly - 1 Hour",
    shortName: "FT Shuffly 1Hr",
    description: "AR-powered shuffleboard with dynamic LED lighting and automatic scoring. Up to 10 players per lane. Located at FastTrax.",
    price: 35,
    image: "https://wuce3at4k1appcmf.public.blob.vercel-storage.com/images/addons/shuffly-Z5qjcBLniaNQKdjQGFI3RfWRwx36HZ.jpg",
    perPerson: false,
    maxPerGroup: 10,
  ...
  {
    id: "24408105",
    name: "HeadPinz Shuffly - 1 Hour",
    shortName: "HP Shuffly 1Hr",
    description: "AR-powered shuffleboard with dynamic LED lighting and automatic scoring. Up to 10 players per lane. Located at HeadPinz next door.",
    price: 35,
    image: "https://wuce3at4k1appcmf.public.blob.vercel-storage.com/images/addons/shuffly-Z5qjcBLniaNQKdjQGFI3RfWRwx36HZ.jpg",
    perPerson: false,
    maxPerGroup: 10,
