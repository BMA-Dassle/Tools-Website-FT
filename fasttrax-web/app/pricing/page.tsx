  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
              ...
              >
                ...
                <p
                  ...
                  style={{ fontSize: "30px", letterSpacing: "1.5px", marginBottom: "12px" }}
                >
                  $4.99
                </p>
                <p
                ...
                >
                  Required for all racers. Valid for one year. Includes your head/neck protector and
                  access to your stats in the FastTrax Racing App.
                </p>
                <BookingLink
                  href="/book/race"
              ...
              >
                ...
                <ul
                  className="font-body list-disc list-inside mb-4 flex-1"
                  style={{ color: "rgba(245,236,238,0.8)", fontSize: "16px", lineHeight: "1.8" }}
                >
                  <li>
                    <strong style={{ color: "rgb(134,82,255)" }}>Nexus Gel Blaster</strong> — $10
                    per person (at HeadPinz)
                  </li>
                  <li>
                    <strong style={{ color: "rgb(0,74,173)" }}>Shuffly</strong> — $10 per group (at
                    FastTrax)
                  </li>
                </ul>
                <BookingLink
            ...
            >
              Disclaimer: App booking required. Races must be booked the day before to guarantee
              your heat. Add-on pricing applies when booked with a race.
            </p>
          </div>
          ...
          <div
            ...
            style={{
              minHeight: "clamp(180px, 30vw, 600px)",
              borderRadius: "16px",
              overflow: "hidden",
            }}
          >
      ...
      <section
        className="bg-[#000418]"
        style={{
          padding: "clamp(40px, 8vw, 70px) clamp(16px, 4vw, 32px) clamp(60px, 10vw, 120px)",
        }}
      >
                  ...
                  {["Kart Class", "Mon–Thu", "Fri–Sun", "Tuesday (Mega Track)"].map((h) => (
                    <th
                      ...
                      style={{
                        ...
                        backgroundColor: "rgba(134,82,255,0.72)",
                      }}
                    >
                      {h}
                    </th>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p
              className="font-body mt-3 max-w-lg mx-auto"
              style={{ color: "rgba(245,236,238,0.5)", fontSize: "15px" }}
            >
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  borderColor: "rgba(0,226,229,0.2)",
                }}
              >
                <p
                ...
                <div className="flex justify-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-body font-bold text-lg" style={{ color: "#00E2E5" }}>
                      {pack.anytime}
                    </p>
                  </div>
                </div>
      ...
      >
        ...
        >
          ...
          <p
            ...
            style={{ color: "rgba(245,236,238,0.8)", fontSize: "16px", lineHeight: "1.6" }}
          >
            All racers must meet specific age and height requirements. Check race types,
            qualification lap times, and kart classes before you book.
          </p>
          <a
            href="/racing"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div
                ...
                style={{ height: "clamp(160px, 30vw, 240px)" }}
              >
                <Image
                  src="https://wuce3at4k1appcmf.public.blob.vercel-storage.com/images/attractions/DSC06445.webp"
                  alt="The Game Zone"
                  fill
                  className="object-cover"
              ...
              <div className="flex-1" style={{ padding: "24px 20px" }}>
                ...
                <ul
                  className="font-body list-disc list-inside"
                  style={{ color: "rgba(245,236,238,0.8)", fontSize: "16px", lineHeight: "1.8" }}
                >
                  <li>
                    <strong>Tap-to-Play:</strong> Load any amount onto a FastTrax Game Card at our
                    kiosks.
                  </li>
                  <li>
                    <strong>Redemption:</strong> Win tickets and trade them for prizes at the
                    Winner&apos;s Circle.
                  </li>
                </ul>
              </div>
            ...
            >
              ...
              <div className="flex-1" style={{ padding: "24px 20px" }}>
                <h3
                  className="font-heading uppercase mb-3"
                  style={{ color: "rgb(0,74,173)", fontSize: "24px", letterSpacing: "1.2px" }}
                >
                  Duckpin Bowling
                </h3>
                <ul
                ...
                >
                  <li>
                    <strong>Per Hour:</strong> $35.00
                  </li>
                  <li>
                    <strong>No Rental Shoes Required!</strong> Bowl in your own clean, closed-toe
                    shoes.
                  </li>
                </ul>
              </div>
            ...
            >
              ...
              >
                <Image
                  src="https://wuce3at4k1appcmf.public.blob.vercel-storage.com/images/attractions/shuffly.webp"
                  alt="Shuffly"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, 33vw"
          ...
          <div style={{ flex: "0 0 54%" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              >
                ...
                <p
                  className="font-body mb-4"
                  style={{ color: "rgba(245,236,238,0.8)", fontSize: "15px", lineHeight: "1.6" }}
                >
                  Add HeadPinz Nexus Gel Blaster to any race for just{" "}
                  <strong className="text-white">$10 more per person</strong>. Select it as an
                  add-on during checkout.
                </p>
                <ul
                  className="font-heading uppercase mb-6 flex-1"
                  style={{
                    color: "rgba(245,236,238,0.8)",
                    fontSize: "16px",
                    lineHeight: "2",
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "rgba(245,236,238,0.8)", fontSize: "15px", lineHeight: "1.6" }}
                >
                  Already qualified for Intermediate speeds? Book your next Intermediate heat while
                  you&apos;re still booking a Starter race and{" "}
                  <strong className="text-white">save on the upgrade</strong>. Stack your heats
                  during checkout for the best deal.
                </p>
                <ul
                  className="font-heading uppercase mb-6 flex-1"
                  style={{
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p
            ...
            style={{ color: "rgba(245,236,238,0.5)", fontSize: "15px" }}
          >
            FastTrax gift cards are perfect for birthdays, holidays, or just because. Available in
            any amount — use them for racing, add-ons, dining, and more.
          </p>
          <a
