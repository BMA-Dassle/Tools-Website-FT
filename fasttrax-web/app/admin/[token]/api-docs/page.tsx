...
/**
 * Swagger UI for the FastTrax Sales Admin API.
 *
 ...
 */
export default function SalesApiDocsPage() {
      ...
      <div className="bg-[#050b1d] text-white px-6 py-4 flex items-center justify-between flex-wrap gap-3 border-b border-white/10">
        <div>
          ...
          <p className="text-white/45 text-xs mt-0.5">
            Read-only sales reporting. Auth via <code className="text-cyan-400">x-api-key</code> header.
          </p>
        </div>
