    ...
    <div className="bg-[#0a1628]">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Attractions", url: "https://headpinz.com/naples/attractions" },
        ]}
      />
      ...
      >
        ...
        >
          ...
          <BookingLink
            ...
            className="inline-flex items-center bg-[#fd5b56] hover:bg-[#ff7a77] text-white font-body font-bold text-base uppercase tracking-wider px-10 py-4 rounded-full transition-all hover:scale-105 mb-4"
