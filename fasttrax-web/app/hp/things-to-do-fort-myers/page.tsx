...
const activities = [
  {
    title: "Bowling",
    body: "24 bowling lanes with VIP sections and HyperBowling interactive projection-mapped lanes. For casual groups and leagues.",
    href: "/book/bowling?location=9172",
  },
  {
    title: "NEXUS laser tag",
    body: "Multi-level laser tag arena. Group outings, birthdays, corporate team building.",
    href: "/fort-myers/attractions",
  },
  {
    title: "Gel blaster arena",
    body: "Low-impact tactical play, eye protection provided. Alternative to paintball and laser tag.",
    href: "/book/gel-blaster",
  },
  {
    title: "Arcade games",
    body: "40+ modern arcade games with ticket redemption. All ages.",
    href: "/fort-myers/attractions",
  },
  {
    title: "HyperBowling & NeoVerse",
    body: "Projection-mapped interactive bowling lanes turn every frame into a game.",
    href: "/fort-myers/attractions",
  },
  {
    title: "Go-kart racing (at FastTrax)",
    body: "FastTrax is the sister center in the same complex — indoor electric kart racing on multi-level tracks.",
    href: "https://fasttraxent.com/racing",
  },
  {
    title: "Nemo's Sports Bistro",
    body: "Full-service restaurant with craft cocktails, bar menu, trackside patio.",
    href: "/menu",
  },
];
...
const byOccasion = [
  {
    heading: "Rainy day?",
    body: "HeadPinz and FastTrax share Global Parkway complex — both fully indoor. Rain doesn't stop play.",
    href: "/fort-myers/attractions",
  },
  {
    ...
    href: "/fort-myers/birthdays",
  },
  {
    heading: "Corporate team building?",
    body: "Group events bundle lanes, private rooms, buffet catering, and laser tag or gel blasters.",
    href: "/fort-myers/group-events",
  },
  {
    heading: "Date night?",
    body: "Bowl a round, hit the arcade, grab cocktails and dinner at Nemo's. Full evening in one stop.",
    href: "/book/bowling?location=9172",
  },
  {
    heading: "Family with young kids?",
    body: "Indoor, climate-controlled, all ages. HyperBowling keeps small kids engaged even without strong bowling skills.",
    href: "/fort-myers/attractions",
  },
  {
    heading: "Leagues?",
    body: "Adult and youth bowling leagues run year-round.",
    href: "/fort-myers",
  },
];
...
const otherVenues = [
  {
    name: "FastTrax (same complex)",
    desc: "Sister center with indoor electric kart racing, duckpin bowling, and shuffleboard. Walk between buildings.",
    href: "https://fasttraxent.com",
  },
  {
    name: "810 Bowling alternative",
    desc: "Compare our bowling + attractions bundle to traditional bowling alleys.",
  ...
  },
  {
    ...
    desc: "Modern interactive bowling vs. traditional alleys.",
    href: "/alternatives/gator-lanes",
  },
  {
    name: "Hi-5 alternative",
    desc: "Family entertainment center comparison.",
    ...
    <div className="min-h-screen bg-[#0a1628] text-white">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: "Things to Do in Fort Myers",
            url: "https://headpinz.com/things-to-do-fort-myers",
          },
        ]}
      />
      ...
      <section style={{ padding: "clamp(80px, 14vw, 160px) clamp(16px, 4vw, 32px) 40px" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Fort Myers has great entertainment for any weather. Here&apos;s a guide to indoor,
            rain-or-shine attractions — starting with HeadPinz and FastTrax on Global Parkway, and
            including comparisons with other SWFL venues so you can pick what fits your group best.
          </p>
        </div>
      </section>
