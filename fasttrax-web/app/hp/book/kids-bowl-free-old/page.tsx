    ...
    try {
      ...
      const returnUrl =
        typeof window !== "undefined"
          ? `${window.location.origin}/hp/book/bowlingold/confirmation?key=${encodeURIComponent(reservationKey)}&center=${centerId}`
          : "";
      ...
      if (result?.NeedPayment && result.ApprovePayment?.Url) {
        ...
        redirect = `/hp/book/bowlingold/confirmation?key=${encodeURIComponent(reservationKey)}&center=${centerId}`;
      }
