...
const OPEN_PRODUCTS: Array<{
  ...
  {
    label: "1 Hr Mon-Thur",
    squareCatalogObjectId: "C2I2FUTKZODAXBL4N7NB4OZG",
    priceCents: 3000,
    sortOrder: 10,
  },
  {
    label: "1 Hr Mon-Thur VIP",
    squareCatalogObjectId: "PI67DZQJVGR5EIXEWLB2ELOJ",
    priceCents: 4500,
    sortOrder: 11,
  },
  {
    label: "1 Hr Fri-Sun",
    squareCatalogObjectId: "QA2R6YZ3D64X63NGQ46LYZRV",
    priceCents: 4000,
    sortOrder: 12,
  },
  {
    label: "1 Hr Fri-Sun VIP",
    squareCatalogObjectId: "OSOZ7RJ6WW7G4CEFL55U7LXF",
    priceCents: 5500,
    sortOrder: 13,
  },
  {
    label: "1.5 Hr Mon-Thur",
    squareCatalogObjectId: "43HJHFSYZNB42NWB2CM7UKOV",
    priceCents: 4500,
    sortOrder: 20,
  },
  {
    label: "1.5 Hr Mon-Thur VIP",
    squareCatalogObjectId: "BESYYLCKLOVD7YE4GYJU24HR",
    priceCents: 6750,
    sortOrder: 21,
  },
  {
    label: "1.5 Hr Fri-Sun",
    squareCatalogObjectId: "BA7XH63Z3KZOYEU5GGTEPASR",
    priceCents: 6000,
    sortOrder: 22,
  },
  {
  ...
  {
    label: "Deals After Dark Unlimited VIP",
    squareCatalogObjectId: "YSA5ATSXBCQWXGG5VP3YFYMX",
    priceCents: 1399,
    sortOrder: 30,
  },
  {
    label: "Fun 4 All",
    squareCatalogObjectId: "TOKSMRAUZSSCXSTJHSZ22TTU",
    priceCents: 1599,
    sortOrder: 40,
  },
  {
    label: "Fun 4 All - VIP",
    squareCatalogObjectId: "RA3DBEYZVIEKIHON7KVMNRMQ",
    priceCents: 1799,
    sortOrder: 41,
  },
  {
    label: "Lunch & Bowl",
    squareCatalogObjectId: "ELVHSZIYEOEOTFQDAS6FYDIS",
    priceCents: 1499,
    sortOrder: 50,
  },
  {
    label: "Lunch & Bowl VIP",
    squareCatalogObjectId: "TH2WRVV2M4UVROYKIPPCIBM2",
    priceCents: 1699,
    sortOrder: 51,
  },
  {
    label: "Midnight Madness",
    squareCatalogObjectId: "ND5N3PMV4AZ5I47U3BJZMLKW",
    priceCents: 1199,
    sortOrder: 60,
  },
  {
    label: "Midnight Madness VIP",
    squareCatalogObjectId: "G6G2AZV3HHKAWLIZUJVVMOVD",
    priceCents: 1399,
    sortOrder: 61,
  },
  // ── NYE events ─────────────────────────────────────────────────────
  {
    label: "NYE Adult Party - Regular",
    squareCatalogObjectId: "AR3NFJIM5V37RWKOBMVQMCH5",
    priceCents: 11900,
    sortOrder: 70,
  },
  {
    label: "NYE Adult Party - VIP",
    squareCatalogObjectId: "YK2QS7F4UECPCHS37PELUDBQ",
    priceCents: 14400,
    sortOrder: 71,
  },
  {
    label: "NYE Family Party - Regular",
    squareCatalogObjectId: "IOTVXOB3W2OCAE2PWR7673VO",
    priceCents: 9900,
    sortOrder: 72,
  },
  {
    label: "NYE Family Party - VIP",
    squareCatalogObjectId: "WOUN6QDIFAOM3M3UB3Q4S73H",
    priceCents: 12400,
    sortOrder: 73,
  },
  // ── Pizza deals ────────────────────────────────────────────────────
  {
    label: "Pizza Bowl - Regular",
    squareCatalogObjectId: "GWQQDLD5J3XAZAOU5STJL3VF",
    priceCents: 6495,
    sortOrder: 80,
  },
  {
    label: "Pizza Bowl - VIP",
    squareCatalogObjectId: "3BET7DOSFNF64GNPMOZTI5SJ",
    priceCents: 7995,
    sortOrder: 81,
  },
];
...
async function main() {
  ...
  console.log(`     POST /api/admin/bowling/v2/square-products`);
  console.log(`       centerCode: TXBSQN0FEKQ11  productKind: addon_shoe`);
  console.log(`       squareCatalogObjectId: ${SHOE_VAR_ID}  priceCents: 500  isActive: true`);
}
