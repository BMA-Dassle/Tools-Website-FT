...
// BowlingPaymentStep, ClickwrapCheckbox, CURRENT_POLICY_VERSION removed — details/payment steps deleted
...
export default function BowlingWizard({ kind }: BowlingWizardProps) {
  ...
  // Guest details (name, email, phone, clickwrap, SMS opt-in) removed —
  // contact info is now collected at unified checkout.
  ...
  async function handleVerify() {
    ...
    try {
      ...
      // Guest name/email/phone no longer stored in wizard state —
      // checkout reads them from the KBF pass via sessionStorage.
  ...
  // Details-step helpers removed (phone lookup, SMS verification, rewards
  // enrollment) — contact info is now collected at unified checkout.
    ...
    <>
      ...
      <main className="min-h-screen pt-28 sm:pt-32 pb-16 px-4" style={{ backgroundColor: BG }}>
        <div className="mx-auto max-w-4xl">
          ...
          {/* Details step removed — contact info collected at unified checkout */}
