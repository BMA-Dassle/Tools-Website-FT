  ...
  return (
    <footer className="bg-[#010A20] border-t border-white/10 pt-12 pb-24 md:pb-8">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mt-5">
            <a
              ...
              className="text-white/40 hover:text-[#00E2E5] transition-colors"
              aria-label="Facebook"
            >
        ...
        {/* Quick Links */}
        <div>
          <h3 className="font-heading font-bold text-lg text-[#00E2E5] uppercase tracking-widest mb-4">
            Quick Links
          </h3>
              ...
              <li key={l.label}>
                {l.href.startsWith("http") ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white/50 hover:text-white text-sm transition-colors font-heading"
                  >
                    {l.label}
                  </a>
                ) : (
        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-white/60">
            <p className="leading-relaxed">
              14501 Global Parkway
              <br />
              Fort Myers, FL 33913
            </p>
            <p>
              <a href="tel:+12394819666" className="hover:text-[#00E2E5] transition-colors">
                (239) 481-9666
              </a>
            </p>
            <p>
            ...
            {agentsOnline && (
              <p>
                <a href="sms:+12394819666" className="hover:text-[#00E2E5] transition-colors">
                  Text Us
                </a>
              </p>
            )}
