...
const activities = [
  ...
  },
  {
    ...
    body: "Smaller balls, shorter lanes, more strikes. Beginner-friendly bowling for groups and families.",
    href: "/book/duck-pin",
  },
  {
    title: "Shuffleboard",
    body: "Old-school, new-school fun. Great for small groups and casual competition.",
    href: "/book/shuffly",
  },
  {
  ...
  {
    title: "Laser tag (at HeadPinz)",
    body: "NEXUS laser tag arena in the same complex as FastTrax. Combine racing + laser tag in one trip.",
    href: "https://headpinz.com/fort-myers/attractions",
  },
  {
    title: "Arcade + redemption",
    body: "50+ modern arcade games with ticket redemption. All-ages friendly.",
    href: "/attractions",
  },
  {
    title: "Nemo's Trackside dining",
    body: "Wood-fired pizza, craft cocktails, and full bar. Sit-down dining with a view of the track.",
    href: "/menu",
  },
];
...
const byOccasion = [
  {
    heading: "Rainy day?",
    body: "FastTrax and HeadPinz are fully indoor — rain, thunderstorms, and Florida humidity don't stop play.",
    href: "/racing",
  },
  {
  ...
  },
  {
    ...
    body: "Private race heats, bundled food and drink, full facility buyouts for 60+ employees.",
    href: "/group-events",
  },
  {
    heading: "Date night?",
    body: "Races, cocktails at Nemo's, arcade, and dessert. Typical evening runs 1.5-2 hours.",
    href: "/racing",
  },
  {
  ...
  },
  {
    ...
    body: "Full bar, cocktails, craft beer. Bowl a round, race a few heats, hit the arcade.",
    href: "/menu",
  },
];
...
const otherVenues = [
  {
    ...
    desc: "Sister center — 24 bowling lanes, NEXUS laser tag, gel blasters, arcade, Nemo's Sports Bistro.",
    href: "https://headpinz.com/fort-myers",
  },
  {
    name: "PopStroke alternative",
    desc: "If you're comparing outdoor putting to indoor entertainment.",
    href: "/alternatives/pop-stroke",
  },
  {
    name: "Topgolf alternative",
    desc: "If you're looking for something other than a driving range.",
    href: "/alternatives/topgolf",
  },
  {
    name: "Dave & Buster's alternative",
    desc: "Same arcade-and-dining vibe plus indoor karting.",
    href: "/alternatives/dave-and-busters",
  },
  {
    name: "Gator Mike's alternative",
    desc: "Indoor option for days the outdoor weather isn't cooperating.",
    href: "/alternatives/gator-mikes",
  },
  {
    name: "See all alternatives",
    desc: "Side-by-side comparisons with 7 SWFL entertainment venues.",
    href: "/alternatives",
  },
];
    ...
    <div className="min-h-screen bg-[#000418] text-white">
      ...
      <section style={{ padding: "clamp(80px, 14vw, 160px) clamp(16px, 4vw, 32px) 40px" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Fort Myers has a great mix of indoor entertainment, outdoor parks, dining, and
            nightlife. Here&apos;s a locals-eye guide to what you can do — with a focus on the
            indoor, rain-or-shine, works-for-any-group options that keep Southwest Florida fun even
            ...
            {byOccasion.map((o) => (
              ...
              >
                <div
                  ...
                  style={{ color: "#00E2E5", fontSize: "11px", letterSpacing: "2px" }}
                >
                  {o.heading}
                </div>
                <p
      ...
      <section style={{ padding: "60px clamp(16px, 4vw, 32px)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          >
            A lot of venues in SWFL do one part of the entertainment stack really well. Here&apos;s
            how we compare.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {otherVenues.map((v) => (
      ...
      >
        <div className="max-w-2xl mx-auto">
          ...
          >
            Book a heat, a lane, or a group event — rain-or-shine, year-round, just off Global
            Parkway.
          </p>
