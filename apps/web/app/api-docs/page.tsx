  ...
  if (!authenticated) {
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <form
          onSubmit={handleAuth}
          className="bg-gray-900 rounded-xl border border-gray-800 p-8 max-w-md w-full space-y-4"
        >
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-lg bg-cyan-500 text-gray-950 font-bold hover:bg-cyan-400 transition-colors"
          >
            Authenticate
          </button>
        </form>
