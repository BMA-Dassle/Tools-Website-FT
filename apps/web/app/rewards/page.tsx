...
export const metadata: Metadata = {
  ...
  description:
    "Join the FastTrax rewards program. Earn points every time you race, play, or dine with us. Redeem for free races, discounts, and exclusive perks.",
  keywords: [
    "FastTrax rewards",
    "FastTrax loyalty",
    "racing rewards",
    ...
    <div className="bg-[#0a1628]">
      ...
      >
        ...
        <p className="font-body text-white/60 text-sm max-w-md mx-auto mb-2">
          Earn Pinz every time you bowl, play, or dine with us. Redeem for free food, discounts, and
          exclusive perks.
        </p>
        <div
          className="mx-auto h-1 w-24 rounded-full mt-4 mb-10"
              ...
              >
                <h2
                  ...
                  style={{
                    ...
                    lineHeight: "1.05",
                    textShadow: "0 0 30px rgba(253,91,86,0.2)",
                  }}
                >
                  Free Wing Friday
                </h2>
