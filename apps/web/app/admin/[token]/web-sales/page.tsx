...
/**
 * v1: `/admin/{ADMIN_CAMERA_TOKEN}/web-sales`.
 *
 * The static token in the path is the credential. Kept alongside the SSO route
 * at `/admin/web-sales` (same component, no credential in the URL) per the v2
 * cutover pattern; the middleware 307s this URL to the clean one, filters
 * intact.
 *
