...
/**
 * v1: `/admin/{ADMIN_CAMERA_TOKEN}/signage`.
 *
 * The static token in the path is the credential. Kept alongside the SSO route
 * at `/admin/signage` (same component, no credential in the URL) per the v2
 ...
 * unchanged from before the split. The SCREENS this tool configures are on the
 * public `/tv/*` routes and are unaffected either way.
 */
