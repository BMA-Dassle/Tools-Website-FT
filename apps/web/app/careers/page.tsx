...
function typeColor(type: string) {
  if (type.toLowerCase().includes("full")) return { bg: "rgba(229,0,0,0.15)", color: red };
    ...
    <main style={{ background: bg, minHeight: "100vh", color: "#fff", paddingBottom: "80px" }}>
      ...
      >
        ...
        >
          ...
          destination. If you thrive in a fast-paced, high-energy environment and want to love where
          you work — we want to hear from you.
        </p>
        <a
          href={APPLY_BASE}
          target="_blank"
