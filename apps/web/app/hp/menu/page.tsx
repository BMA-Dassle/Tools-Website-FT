...
const coral = "#fd5b56";
const HAPPY_HOUR_PDF =
  "https://wuce3at4k1appcmf.public.blob.vercel-storage.com/documents/nemos-happy-hour.pdf";
const gold = "#FFD700";
const cyan = "#00E2E5";
...
const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    accent: coral,
    items: [{ name: "Wings & Things Combo", price: "12" }],
  },
  {
    name: "Boneless Wings",
  ...
  },
  {
    ...
    items: [
      {
        name: "Nemo's Classic Burger",
        desc: "Hand crafted choice ground beef, cooked to your liking, topped with lettuce, tomato and red onion",
        price: "14",
      },
      {
        name: "Nemo's Smashburger",
        desc: "Topped with lettuce, tomato and red onion",
        price: "12",
      },
      {
        name: "Jalapeno Cheddar Smashburger",
        desc: "Topped with fried jalapenos, cheddar cheese and finished with jalapeno ranch",
        price: "12",
      },
      {
        name: "Mushroom Swiss Smashburger",
        desc: "Topped with grilled mushrooms and melted Swiss cheese",
        price: "12",
      },
      {
        name: "Smokehouse Smashburger",
        desc: "Topped with BBQ sauce, cheddar, peppered smoked bacon and finished with a fried onion ring",
        price: "13",
      },
      {
        name: "The Hangover Smashburger",
        desc: "Topped with a fried egg sunny side up, American cheese and peppered smoked bacon",
        price: "14",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Nemo's Macho Nachos",
        desc: "A mound of freshly fried tri-colored tortilla chips topped with chili, house-made queso, shredded lettuce, diced tomato and red onion",
        price: "15",
      },
      {
        name: "Meatball Sliders",
        desc: "Beef and pork meatballs slow simmered in marinara sauce, smothered in melted provolone cheese, served with garlic bread",
        price: "14",
      },
      {
        name: "Fried Pickles",
        desc: "Battered and fried to perfection pickle fries served with jalapeno ranch",
        price: "9",
      },
      {
        name: "Nemo's Chips & Queso",
        desc: "Freshly fried house-made tortilla chips served with house-made queso",
        price: "9.5",
      },
      {
        name: "Bavarian Pretzel Sticks",
        desc: "Fresh soft pretzel sticks served with warm cheese",
        price: "10",
      },
      {
        name: "Mozzarella Sticks",
        desc: "Battered and fried to perfection served with house marinara",
        price: "10",
      },
      {
        name: "Loaded Fries",
        desc: "Golden waffle fries covered in queso with peppered smoked bacon and scallions",
        price: "11",
      },
      {
        name: "Chicken Teriyaki Potstickers",
        desc: "Pan-fried chicken & cabbage potstickers finished with a sweet teriyaki sauce",
        price: "10",
      },
      {
        name: "Shrimp Manuelo",
        desc: "Large shrimp fried to perfection then tossed in boom boom sauce, topped with scallions",
        price: "13.5",
      },
      {
        name: "Mac & Cheese Bites",
        desc: "Battered and fried to perfection served with house garlic sauce",
        price: "9",
      },
      { name: "Chicken Tenders", desc: "Battered and fried to perfection", price: "12" },
      {
        name: "Quesadilla",
        desc: "Flour tortilla with cheddar jack cheese, served with shredded lettuce, salsa and sour cream",
        price: "11",
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "Fried or grilled chicken tossed in Nashville hot sauce with lettuce, served on a bun",
        price: "13.5",
      },
      {
        name: "Meatball Sub",
        desc: "Beef and pork meatballs slow simmered in marinara sauce, smothered in melted provolone on a hoagie roll",
        price: "14",
      },
      {
        name: "BBQ Pulled Pork",
        desc: "Slow smoked pork smothered in BBQ sauce topped with coleslaw served on a bun",
        price: "13",
      },
      { name: "Grilled Hot Dog", desc: "All beef hot dog grilled to perfection", price: "9" },
      {
        name: "Classic Cuban",
        desc: "Slow-cooked hand pulled pork, sweet ham with Swiss cheese, mustard and dill pickles, served hot & pressed",
        price: "12.5",
      },
      {
        name: "Nemos Club",
        desc: "Oven roasted turkey breast, lettuce, tomato, bacon and mayo piled high between 3 pieces of toasted thick cut white bread",
        price: "13.5",
      },
      {
        name: "BLT",
        desc: "8 strips of applewood smoked bacon, lettuce, tomato and mayo on toasted thick cut white bread",
        price: "11.5",
      },
      {
        name: "Cheesesteak",
        desc: "Thinly sliced steak with grilled onions, mushrooms and peppers smothered in melted provolone cheese",
        price: "14.5",
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "With fresh romaine lettuce in a creamy Caesar dressing with shaved parmesan",
        price: "12",
      },
      {
        name: "Buffalo Chicken Wrap",
        desc: "Tossed in buffalo sauce with lettuce, tomato, and cheddar jack cheese",
        price: "12",
      },
      {
        name: "Boom Boom Shrimp Wrap",
        desc: "Tossed in boom boom sauce with lettuce, tomato and cheddar jack cheese",
        price: "14",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "House Salad",
        desc: "Crisp romaine lettuce topped with croutons, tomatoes, shredded red onion, cheddar jack cheese and choice of dressing",
        price: "9.5",
      },
      {
        name: "Caesar Salad",
        desc: "Crisp romaine tossed in a creamy Caesar dressing topped with shaved parmesan and croutons",
        price: "10.5",
      },
      {
        name: "Chili Taco Salad",
        desc: "Fried tortilla bowl filled with chili, romaine, lettuce, cheddar jack, diced tomato, sour cream, served with side of salsa",
        price: "14",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: "Grilled Cheese",
        desc: "Melted American cheese between 2 slices of buttered white bread",
        price: "8",
      },
      { name: "Hot Dog", desc: "All beef hot dog", price: "8" },
      {
        name: "Chicken Tenders",
        desc: "2 fried chicken tenders with dipping sauce",
        price: "10.5",
      },
    ...
    items: [
      {
        ...
        desc: "Warm brownie topped with vanilla ice cream, whipped cream, caramel and chocolate drizzle",
        price: "8.5",
      },
      {
        name: "Ice Cream Sundae",
        desc: "Vanilla ice cream with your choice of toppings",
        price: "4.5",
      },
    ],
  },
