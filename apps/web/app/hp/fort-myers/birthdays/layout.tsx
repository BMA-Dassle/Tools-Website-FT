  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Our birthday party packages are designed for guests ages 17 and under.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Each lane accommodates up to 6 guests. You can reserve 2, 4, or 6 lanes depending on your party size.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Absolutely! Adults are welcome to attend as guests.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Every package includes one food choice: pizza + soda, hot dog + fries + soda, or chicken tenders + fries + soda.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "We recommend booking at least 2 weeks in advance. Popular dates and weekends fill up quickly.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes! You're welcome to bring your own birthday cake or cupcakes. We'll provide the plates and utensils.",
      },
    },
  ],
};
