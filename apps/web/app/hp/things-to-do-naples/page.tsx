...
const activities = [
  {
    title: "Bowling",
    body: "32 bowling lanes, including VIP sections and HyperBowling interactive projection-mapped lanes. Good for any age.",
    href: "/book/bowling?location=3148",
  },
  {
    title: "NEXUS laser tag",
    body: "Multi-level laser tag arena. Kids and adult groups both fit.",
    href: "/naples/attractions",
  },
  {
    title: "Gel blaster arena",
    body: "Low-impact tactical play with eye protection provided. Alternative to paintball.",
    href: "/book/gel-blaster?location=naples",
  },
  {
    title: "Arcade games",
    body: "40+ modern arcade games with ticket redemption. All-ages friendly.",
    href: "/naples/attractions",
  },
  {
    title: "HyperBowling & NeoVerse",
    body: "Interactive projection-mapped lanes turn every frame into a mini-game. Great for kids and mixed-ability groups.",
    href: "/naples/attractions",
  },
  {
    title: "Nemo's Sports Bistro",
    body: "Full-service restaurant with craft cocktails, bar menu, and a seasonal menu.",
    href: "/menu",
  },
];
...
const byOccasion = [
  {
    heading: "Rainy day?",
    body: "HeadPinz Naples is fully indoor. Rain, thunderstorms, and humidity don't stop play.",
    href: "/naples/attractions",
  },
  {
    heading: "Kids birthday party?",
    body: "Bronze, Silver, and VIP packages include lanes, arcade cards, laser tag, and food. For 10-60 guests.",
    href: "/naples/birthdays",
  },
  {
    heading: "Corporate team building?",
    body: "Group events with lanes, private rooms, buffet catering, and optional laser tag.",
    href: "/naples/group-events",
  },
  {
    heading: "Date night?",
    body: "Bowl a round, hit the arcade, and grab cocktails and dinner at Nemo's. A full evening in one stop.",
    href: "/book/bowling?location=3148",
  },
  {
    heading: "Family with young kids?",
    body: "Indoor, climate-controlled, and all ages welcome. HyperBowling keeps kids engaged even if they're not strong bowlers.",
    href: "/naples/attractions",
  },
  {
    heading: "Guys or girls night out?",
    body: "VIP lanes, full bar, craft cocktails, arcade. The adult-friendly corner of HeadPinz.",
    href: "/book/bowling?location=3148",
  },
];
...
const otherVenues = [
  {
    ...
    desc: "Sister center with the same attractions + 24 lanes. If you're driving north.",
    href: "/fort-myers",
  },
  {
    name: "Hi-5 alternative",
    desc: "If you're comparing family entertainment centers in SWFL.",
    href: "/alternatives/high-five",
  },
  {
    name: "Gator Lanes alternative",
    desc: "Modern bowling with interactive tech vs. traditional alleys.",
    href: "/alternatives/gator-lanes",
  },
  {
    name: "810 Bowling alternative",
    desc: "Bowling + more under one roof.",
    href: "/alternatives/810-bowling",
  },
  {
    name: "Bowlero alternative",
    desc: "Locally owned with premium lanes and more attractions.",
    href: "/alternatives/bowlero",
  },
  {
    name: "See all alternatives",
    desc: "Side-by-side comparisons with 4 SWFL entertainment venues.",
    href: "/alternatives",
  },
];
...
export default function ThingsToDoNaplesPage() {
  return (
    <div className="min-h-screen bg-[#0a1628] text-white">
      ...
      <section style={{ padding: "clamp(80px, 14vw, 160px) clamp(16px, 4vw, 32px) 40px" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            entertainment that works rain or shine, here&apos;s what&apos;s on the list. HeadPinz
            Naples is our hometown spot on Radio Lane, and below we&apos;ve added a few alternative
            comparisons to help you decide what fits your group best.
          </p>
        </div>
      </section>
      ...
      {/* By occasion */}
      <section
        style={{ padding: "60px clamp(16px, 4vw, 32px)", backgroundColor: "rgba(18,48,117,0.15)" }}
      >
        <div className="max-w-5xl mx-auto">
          <h2
            className="font-heading font-black uppercase italic text-white text-center"
      ...
      <section style={{ padding: "60px clamp(16px, 4vw, 32px)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <p
            className="font-body text-white/60 text-center mx-auto mb-8"
            style={{ fontSize: "14px", maxWidth: "50ch" }}
          >
            Here&apos;s how HeadPinz stacks up against other SWFL venues — pick what fits your group
            best.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {otherVenues.map((v) => (
      ...
      >
        <div className="max-w-2xl mx-auto">
          ...
          >
            Book a lane, laser tag, or group event at HeadPinz Naples on Radio Lane. Rain-or-shine,
            any day of the week.
          </p>
