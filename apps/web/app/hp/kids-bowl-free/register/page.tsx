...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "register kids bowling",
    "free bowling sign up",
  ...
  return (
    <div className="bg-[#0a1628]">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: "60vh" }}>
        ...
        >
          ...
          <p className="font-body text-white/70 text-sm max-w-lg mx-auto">
            Sign up through the Kids Bowl Free portal, then book your lane. It only takes a minute
            per child.
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Select your nearest center below and click Register. You'll be taken to the Kids Bowl Free portal.",
                accent: "#fd5b56",
              },
              {
                step: "2",
                title: "Sign Up Each Child",
                desc: "A parent or grandparent enters each child's info. Kids must be 15 or younger. Register each child separately.",
                accent: "#FFD700",
              },
              {
                step: "3",
                title: "Get Your Passes",
                desc: "You'll receive weekly passes via email or the Kids Bowl Free mobile app. Show them at check-in to bowl free!",
                accent: "#00E2E5",
              },
            ].map((s) => (
              <div
            ...
            {[
              ...
              >
                ...
                <span
                  ...
                  style={{ color: row.on ? "#00E2E5" : "rgba(255,255,255,0.3)" }}
                >
                  {row.time}
                </span>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {locations.map((loc) => (
              <div
                ...
                style={{
                  backgroundColor: "rgba(7,16,39,0.5)",
                  border: `1.78px dashed ${loc.accent}35`,
                }}
              >
                {/* Location color bar */}
                ...
                <div className="p-6 text-center flex flex-col flex-1">
                  ...
                  <a
                    ...
                    className="font-body text-white/60 text-sm hover:text-white transition-colors mb-6"
                  >
                    {loc.phone}
                  </a>
      ...
      <section
        ...
        style={{ minHeight: "clamp(250px, 35vh, 350px)" }}
      >
        <Image
          src={`${BLOB}/images/headpinz/kbf-banner.png`}
          alt="Kids bowling"
