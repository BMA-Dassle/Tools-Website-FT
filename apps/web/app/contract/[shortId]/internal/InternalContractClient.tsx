          ...
          <>
            <div className="mb-6 rounded-2xl border border-white/10 bg-[#071027] p-6">
              <div className="mb-4 flex items-start justify-between">
                <div>
                  <h2 className="text-2xl font-bold">{quote.eventName}</h2>
                  <p className="text-sm text-gray-400">{quote.eventDateDisplay} &middot; {quote.centerName}</p>
                </div>
                <div className="text-right">
                  <p className="text-xs text-gray-500">Event Total</p>
                  <p className="text-2xl font-bold text-white">{fmtDollars(quote.totalCents)}</p>
                </div>
              </div>
            ...
            {/* Payment schedule */}
            <div className="mb-6 rounded-2xl border border-white/10 bg-[#071027] p-5">
              <h3 className="mb-3 text-xs font-semibold uppercase tracking-widest text-gray-400">Payment Schedule</h3>
              <div className="flex items-center justify-between border-b border-white/10 pb-3">
                <div><p className="font-semibold">50% Deposit — Due Today</p><p className="text-sm text-gray-400">After signing</p></div>
                <p className="text-lg font-bold text-cyan-400">{fmtDollars(quote.depositDueCents)}</p>
              </div>
              <div className="flex items-center justify-between pt-3">
                <div><p className="font-semibold">Remaining Balance — 72 Hours Before</p><p className="text-sm text-gray-400">Charged to card on file</p></div>
            ...
            {/* Planner */}
            {quote.plannerFirst && (
              <div className="mb-6 rounded-2xl border border-white/10 bg-[#071027] p-4">
                ...
                <div className="mt-1 text-sm text-gray-400">
                  {quote.plannerPhone && <p>{quote.plannerPhone}</p>}
                  {quote.plannerEmail && <p>{quote.plannerEmail}</p>}
                </div>
                {quote.notes && (
                  <div className="mt-3 rounded-lg bg-white/5 p-3">
                    <p className="mb-1 text-xs font-semibold uppercase text-gray-500">Planner Notes</p>
