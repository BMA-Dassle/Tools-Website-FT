...
export const RACE_TYPE_CARDS: RaceTypeCard[] = [
  ...
  },
  {
    ...
    note: "The only junior race on Mega days",
  },
];
...
export const KART_CLASS_CARDS: KartClassCard[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Note",
        value: "Mega days are Junior Pro only — no Junior Starter or Intermediate",
      },
    ],
  },
];
...
export const TRACK_LAYOUTS: TrackLayoutInfo[] = [
  ...
  },
  {
    ...
    color: "rgb(134,82,255)",
    lengthFt: 2108,
    blurb: "Florida's longest multi-level track — on Mega days only.",
    gif: `${BLOB}/images/tracks/mega-track-layout.gif`,
    warning:
      "Junior Notice: Mega days run Junior Pro races only — no Junior Starter or Junior Intermediate. Juniors must qualify all the way up to Junior Pro on a split-track day first.",
  },
];
