...
export const REP_SEED: readonly RepSeed[] = [
  ...
  },
  {
    ...
    bmiUserId: "465247",
    bmiUserIds: { headpinzftmyers: "465247", headpinznaples: "41096" },
    bmiUsername: "Lori Lehman",
    bmiUsernames: { headpinzftmyers: "Lori Lehman", headpinznaples: "Lori" },
  ...
  },
  {
    ...
    bmiUserId: "30080112",
    bmiUserIds: { headpinzftmyers: "30080112", headpinznaples: "6400642" },
  ...
  },
  {
    ...
    bmiUserId: "7251049",
    bmiUserIds: { headpinzftmyers: "7251049" },
    bmiUsername: "Jacob Elliott",
    bmiUsernames: { headpinzftmyers: "Jacob Elliott" },
    sevenShiftsUserId: null,
    teamsChatId: null,
    phoneE164: null,
    centres: ALL_CENTRES,
  ...
  },
  {
    ...
    bmiUserId: "75262",
    bmiUserIds: { headpinzftmyers: "75262", headpinznaples: "25228" },
    bmiUsername: "Eric Osborn",
    bmiUsernames: { headpinzftmyers: "Eric Osborn", headpinznaples: "Eric" },
    sevenShiftsUserId: null,
    teamsChatId: null,
    phoneE164: null,
    centres: ALL_CENTRES,
...
export const RULE_SEED: readonly RuleSeed[] = [
  ...
  },
  {
    position: 5,
    kind: "avail",
    label: "Prefer whoever is on shift now, then the next shift — balanced by volume",
    when: {},
    then: { onShift: true },
