...
export const SCREENS: Record<ScreenId, ScreenLoader> = {
  ...
  pipeline: () => import("~/components/features/crm/pipeline/PipelineScreen"),
  ...
  cold: () => import("~/components/features/crm/cold/ColdListsScreen"),
  collateral: () => import("~/components/features/crm/collateral/CollateralScreen"),
  accountability: () => import("~/components/features/crm/accountability/AccountabilityScreen"),
  kpi: () => import("~/components/features/crm/kpi/KpiScreen"),
  goals: () => import("~/components/features/crm/kpi/GoalsScreen"),
