...
export function RaceTypes() {
  return (
    <div className="flex flex-col gap-[28px] pb-[48px]">
      <div className="text-[28px] leading-snug text-white/65">
        Every racer starts in Starter. Beat the qualifying lap time and the next speed unlocks on
        your racing license — no levels skipped.
      </div>
