...
export const es: Record<CoreKey, string> = {
  ...
  "confirmation.lane.readyPrompt": "¿La abrimos ahora para que empieces a jugar?",
  "confirmation.lane.opening": "Abriendo…",
  "confirmation.lane.openButton": "Abrir mi pista",
  "confirmation.lane.later": "Después",
  "confirmation.lane.word.one": "Pista",
  "confirmation.lane.word.many": "Pistas",
  "confirmation.lane.statusReady": "Lista",
  "confirmation.lane.statusOpen": "Abierta — a jugar",
  "confirmation.lane.autoOpen":
    "Se abrirá automáticamente en {secs} s — toca Después para esperar.",
