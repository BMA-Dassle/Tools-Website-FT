...
export const flowEn = {
  ...
  "stepReason.megaTuesday": "First-time juniors can’t race on Mega Tuesdays.",
...
export const flowEs: Record<keyof typeof flowEn, string> = {
  ...
  "stepReason.megaTuesday": "Los juniors por primera vez no pueden correr los Mega Tuesdays.",
