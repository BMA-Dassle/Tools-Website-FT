...
export const miscEn = {
  ...
  "signin.phone.badge": "On your phone",
  "signin.phone.sub": "Adults 18+ — scan & sign in on your own phone.",
  "signin.license.badge": "Recommended",
  "signin.license.title": "Scan your driver’s license",
  "signin.license.sub": "No typing — license or state ID, we’ll fill it in.",
...
export const miscEs: Record<keyof typeof miscEn, string> = {
  ...
  "signin.phone.badge": "En tu teléfono",
  "signin.phone.sub": "Adultos 18+ — escanea e inicia sesión en tu propio teléfono.",
  "signin.license.badge": "Recomendado",
  "signin.license.title": "Escanea tu licencia de conducir",
  "signin.license.sub":
    "Sin escribir — licencia o identificación estatal, la completaremos por ti.",
