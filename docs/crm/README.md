...
| Feature code   | `apps/web/src/features/crm/<sub>/{data,service,schemas,queries,index}.ts`                                                                        | subs: `core reps leads activities rules statuses bmi sms email calls availability collateral cold kpi jobs`      |
