...
| `CRM_JACOB_TEAMS_CHAT_ID`                                                                              | the new-lead queue card (`leads/service/notify.ts`)                             | B3 — unset = card skipped with a logged reason (owner supplies a chat the bot is already in)                    |
