...
<#
HEADPINZ FORT MYERS (center 12) bridge setup.

  irm https://raw.githubusercontent.com/BMA-Dassle/Tools-Website-FT/main/game-card-bridge/install-headpinz-fm.ps1 -OutFile C:\work\hpfm.ps1
  C:\work\hpfm.ps1      # prompts for the secret (Vercel GAME_CARD_BRIDGE_SECRET)
...
& $installer -Center 12 -Secret $Secret
